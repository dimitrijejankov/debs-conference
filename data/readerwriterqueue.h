...
public:
	...
	explicit reader_writer_queue(size_t maxSize = 15)
#ifndef NDEBUG
		: enqueuing(false)
		,dequeuing(false)
#endif
...
private:
	...
	// Disable copying
	reader_writer_queue(reader_writer_queue const&) {  }

	// Disable assignment
	reader_writer_queue& operator=(reader_writer_queue const&) {  }
...
template<typename T, size_t MAX_BLOCK_SIZE = 512>
class blocking_reader_writer_queue
{
private:
	typedef ::concurent::reader_writer_queue<T, MAX_BLOCK_SIZE> ReaderWriterQueue;
	
public:
	explicit blocking_reader_writer_queue(size_t maxSize = 15)
		: inner(maxSize)
	{ }
...
private:
	...
	blocking_reader_writer_queue(ReaderWriterQueue const&) {  }
	blocking_reader_writer_queue& operator=(ReaderWriterQueue const&) {  }
